...
export const Route = createFileRoute("/dashboard")({
  head: () => ({
    meta: [
      { title: "Dashboard — Interview Twin AI" },
      {
        name: "description",
        content: "Your employability score, recent interviews, and progress at a glance.",
      },
    ],
  }),
  component: Dashboard,
  ...
  return (
    <DashboardShell
      ...
      actions={
        <Button
          asChild
          className="gradient-primary text-primary-foreground shadow-glow hidden sm:inline-flex"
        >
      ...
      <div className="mt-6 grid gap-4 lg:grid-cols-3">
        ...
        <Card className="border-border/60 shadow-card lg:col-span-2">
          <CardHeader>
            ...
            <CardDescription>Per-skill detail with targets</CardDescription>
          </CardHeader>
              ...
              <div key={s.l}>
                ...
                <div className="mt-2 h-2 rounded-full bg-muted overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${s.v}%`,
                      background: `linear-gradient(90deg, ${s.c}, var(--color-primary-glow))`,
                    }}
                  />
                </div>
              </div>
        ...
        <Card className="border-border/60 shadow-card">
          <CardHeader>
            ...
            <CardDescription>3 actions to boost your score</CardDescription>
          </CardHeader>
      ...
      <Card className="mt-6 border-border/60 shadow-card">
        <CardHeader className="flex flex-row items-center justify-between">
          <div>
            ...
            <CardDescription>Replay or compare your last sessions</CardDescription>
          </div>
            ...
            {recent.map((r) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground flex items-center gap-2">
                      <Clock className="size-3" /> {r.date} · {r.type} · {r.level}
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-4">
                  ...
                  <Badge
                    variant="secondary"
                    className={`rounded-full ${r.score >= 85 ? "text-success bg-success/15" : r.score >= 75 ? "text-info bg-info/15" : "text-warning bg-warning/15"}`}
                  >
